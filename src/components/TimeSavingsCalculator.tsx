    ...
    <div className="relative overflow-hidden rounded-3xl border border-amber-200/70 bg-gradient-to-br from-amber-700 via-orange-700 to-rose-600 p-8 text-white shadow-xl shadow-orange-900/25 sm:p-12">
      ...
      <div className="relative z-10">
        ...
        <div className="flex flex-col gap-12 lg:flex-row lg:items-center">
          <div className="flex-1 space-y-8">
            <div>
              <div className="mb-2 flex items-center justify-between">
                <label className="text-xs font-medium uppercase tracking-wider text-amber-200">
                  Antal kunder
                </label>
          ...
          <div className="flex flex-1 items-center justify-center border-t border-amber-200/35 pt-8 lg:border-l lg:border-t-0 lg:pt-0">
