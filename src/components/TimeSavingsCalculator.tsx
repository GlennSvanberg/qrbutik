...
export function TimeSavingsCalculator({
  ...
  return (
    <div className="relative overflow-hidden rounded-3xl bg-indigo-900 p-8 text-white shadow-xl sm:p-12">
      <div className="absolute top-0 right-0 -mt-10 -mr-10 h-64 w-64 rounded-full bg-indigo-800 opacity-20 blur-3xl" />
      <div className="absolute bottom-0 left-0 -mb-10 -ml-10 h-64 w-64 rounded-full bg-indigo-500 opacity-20 blur-3xl" />

      <div className="relative z-10">
        <h2 className="mb-2 text-2xl font-semibold">{title}</h2>
        <p className="mb-8 text-indigo-200">{subtitle}</p>
