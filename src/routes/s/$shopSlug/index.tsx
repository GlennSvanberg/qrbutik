  ...
  return (
    <main className="relaxed-page-shell min-h-screen bg-transparent pb-32">
      <div className="mx-auto flex w-full max-w-2xl flex-col gap-6 px-4 py-8">
        ...
        {shopSlug === 'glenn' ? (
          <section className="relaxed-surface border-amber-200 bg-amber-50/70 px-6 py-5 text-center">
          ...
          <div className="flex flex-col gap-3">
            {products.map((product) => {
              ...
              return (
                <div
                  key={product._id}
                  className="relaxed-surface-soft flex items-center justify-between p-5 transition-all hover:border-amber-200"
                >
        ...
        <div className="fixed bottom-0 left-0 right-0 z-50 border-t border-slate-200/80 bg-white/70 p-4 backdrop-blur-xl">
          <div className="mx-auto flex max-w-2xl flex-col gap-3">
            ...
            <button
              ...
              className="relaxed-primary-button flex w-full items-center justify-center gap-3 rounded-2xl py-4 text-lg font-bold text-white shadow-lg shadow-amber-300/40 active:scale-[0.98] disabled:opacity-50 disabled:active:scale-100"
